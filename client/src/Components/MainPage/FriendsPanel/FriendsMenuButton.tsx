...
export default function FriendsMenuButton() {
    ...
    const { fetchFriends, fetchPendingRequests, pendingReceived } = useFriendsStore();
    ...
    function onFriendClick(friendId: SetStateAction<string | null>) {
                ...
                <div className="flex flex-col items-end space-y-2 sm:flex-row sm:items-end sm:space-y-0 sm:space-x-2">
                    ...
                    >
                        <FriendsDropdownMenu 
                            ...
                            onAddFriendClick={() => setOpenAddFriend(true)}
                        />
                    </div>
                </div>
            )}
